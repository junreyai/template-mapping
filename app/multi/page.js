...
export default function Multi() {
  ...
  useEffect(() => {
    const loadTemplate = async () => {
      ...
      try {
        ...
        setError(error.message || 'Error loading multi template');
  ...
  const handleProcess = useCallback(async () => {
    ...
    try {
      ...
      setActiveFile(selectedFiles[0]); // Set the first selected file as active
      setShowMapping(true);
            ...
            {uploadedFiles.length > 0 && (
              <div className="flex justify-center mt-6">
                <button 
                  ...
                  disabled={!selectedFiles.length || !templateFile}
                >
                  {!templateFile 
                    ? 'Loading Template...' 
                ...
                {templateFiles.map((templateFile, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center justify-end" style={{ width: '30px' }}>
                        <button className="p-1.5 opacity-0">
                          <Image 
                            src="/close.png"
                ...
                {!generatedTemplate ? (
                  <div className="flex justify-center">
                    <button
                      ...
                      className={`px-6 py-3 rounded-lg transition-colors ${
                        selectedFiles.length > 0 && Object.keys(mappings).length > 0
                          ? 'bg-[#64afec] hover:bg-[#5193c7] text-white' 
                          : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                      }`}
                    >
                  ...
                  <div className="p-4 bg-green-50 rounded-lg">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-4 py-2 transition-colors text-sm flex items-center gap-2 hover:bg-green-100 rounded-lg"
